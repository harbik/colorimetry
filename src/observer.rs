...
The distribution of the different type of cones is not uniform within the retina, with the vision center, the 'Fovea', with an angular extend of about 2º, has the highest density of the three types.
For off-axis vision the cone density drops quickly, while beyond an angle of 10º they disappear, leaving only the rods, used for vision in low light conditions.
...
Typically, observers look at a disk with an angular extend of 2º, composed of a left and right half, called a "bipartite field".
