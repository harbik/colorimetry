...
- A spectral color management use case, demonstrating matching the Munsell paint chip <i>5 BG 5/8</i> to its sRGB equivalent (LED_B2 illuminant, CIE 2015 10° observer).
