...
pub fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    .draw_spectral_locus_ticks(440..651, 10, 15, style_attr!(class: "spectral-locus-ticks"))
    .draw_spectral_locus_ticks(460..631, 1, 7, style_attr!(class:"spectral-locus-ticks"))
